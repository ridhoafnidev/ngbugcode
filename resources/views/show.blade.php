...
<div class="container">
    <div class="row">
        <!-- Latest Posts -->
        <main class="post blog-post col-lg-8" id="box-main">
            <div class="container">
                <div class="card" style="padding:48px;">
                    <div class="post-single">
                        <div class="post-thumbnail"><img src="{{ asset($post->featured) }}" alt="..." class="img-fluid">
                        </div>
                        <div class="post-details">
                            <div class="post-meta d-flex justify-content-between">
                                <div class="category"><a
                                        href="{{ url('/blog/category/' . $post->category->slug) }}">{{ $post->category->title }}</a>
                                </div>
                            </div>
                            <h1>{{ $post->title }}<a href="#"><i class="fa fa-bookmark-o"></i></a></h1>
                            <div class="post-footer d-flex align-items-center flex-column flex-sm-row"><a href="#"
                                    class="author d-flex align-items-center flex-wrap">
                                    <div class="avatar"><img src="{{ asset($post->user->avatar) }}" alt="..."
                                            class="img-fluid"></div>
                                ...
                                <div class="comment">
                                    <div class="comment-header d-flex justify-content-between">
                                        <div class="user d-flex align-items-center">
                                            <div class="image"><img src="{{ asset('assets/blog/img/user.svg') }}"
                            ...
                            <div class="add-comment">
                                <header>
                                    <h3 class="h6">Tulis komentar anda</h3>
                                </header>
                                {!! Form::open(['route' => ['post.comment', $post->slug], 'method' => 'POST', 'class' =>
                                'commenting-form']) !!}
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        {!! Form::text('name', null, ['class' => $errors->has('name') ? 'form-control
                                        is-invalid' : 'form-control', 'placeholder' => 'Nama', 'required'])
                                        !!}
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="form-group col-md-12">
                                        {!! Form::textarea('body', null, ['id' => 'textarea', 'class' =>
                                        $errors->has('body') ? 'form-control is-invalid' : 'form-control', 'placeholder'
                                        => 'Tulis komentar anda', 'required']) !!}
                                        @if ($errors->has('body'))
                                        <span class="invalid-feedback">
        ...
        <aside class="col-lg-4">
            ...
            @include('layouts.blog.partials._widget-latest-articels')
